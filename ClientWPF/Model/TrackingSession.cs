...
namespace ClientWPF.Model
{
    class TrackingSession
    {
        ...
        void FireTrackingEvent(object a, EventArgs e)
        {
            ...
            //RESTConsume.AddState(state);
            if (onTrackingDetected != null)
                 onTrackingDetected(a, e);
        }

        private void UpdateGUIPercent(object myObject, EventArguments.PercentEventArgs myArgs)
        {
            if (OnPercentageReceived != null)
                OnPercentageReceived(this, myArgs);
        }
